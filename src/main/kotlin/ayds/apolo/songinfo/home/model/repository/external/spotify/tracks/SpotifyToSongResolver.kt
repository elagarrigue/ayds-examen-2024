...
interface SpotifyToSongResolver {
    fun getSongFromExternalData(serviceData: String?): List<SpotifySong>?
}
...
internal class JsonToSongResolver : SpotifyToSongResolver {
    ...
    override fun getSongFromExternalData(serviceData: String?): List<SpotifySong>? =
        try {
